...
- **Neural Engineering**: Understanding the intricate mechanisms underlying neural disorders and diseases
- **Wearable Robotics**: Developing exoskeletons and assistive devices for rehabilitation
- **Biosignal Processing**: EMG, EEG, and corticomuscular coherence analysis
- **Neurorehabilitation**: Sensorimotor-integrated rehabilitation approaches for stroke patients
- **Human-Robot Interaction**: Designing intuitive interfaces for rehabilitation robotics

Education
======
- **Ph.D. in Biomedical Engineering** (2021-2025)  
  Hong Kong Polytechnic University  
  Focus: Neural Engineering, Sensorimotor-Integrated Rehabilitation

- **M.Eng. in Mechatronics Engineering** (2018-2020)  
  Harbin Institute of Technology  
  Focus: Rehabilitation Robotics, Upper Limb Exoskeleton

- **B.S. in Mechatronics** (2014-2018)  
  Harbin Institute of Technology  
  Focus: Robotics, Smart Equipment, Wearable Sensors
